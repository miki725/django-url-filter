...
from django_ufilter.exceptions import SkipFilter
...
class TestModelFilterSet(object):
    ...
    def test_get_filters_no_relations_place_diff_source(self):
        ...
        assert set(filters.keys()) == {"id", "name", "location"}
    ...
    def test_get_filters_no_relations_place_exclude_address(self):
        ...
        assert set(filters.keys()) == {"id", "name"}
    ...
    def test_get_filters_no_relations_restaurant(self):
        ...
        assert set(filters.keys()) == {"serves_pizza", "serves_hot_dogs"}
    ...
    def test_get_filters_with_only_reverse_relations(self):
        ...
        assert set(filters.keys()) == {"id", "name", "address", "restaurant"}
    ...
    def test_get_filters_with_both_reverse_and_direct_relations(self):
        ...
        assert set(filters["place"].filters.keys()) == {"id", "name", "address"}
        assert set(filters["waiter"].filters.keys()) == {"id", "name"}
    ...
    def test_get_filters_with_reverse_many_to_many_relations(self):
        ...
        assert set(filters.keys()) == {"id", "title", "articles"}
        assert set(filters["articles"].filters.keys()) == {"id", "headline"}
    ...
    def test_get_filters_with_many_to_many_relations(self):
        ...
        assert set(filters.keys()) == {"id", "headline", "publications"}
        assert set(filters["publications"].filters.keys()) == {"id", "title"}
    ...
    def test_get_filters_with_many_to_one_relations(self):
        ...
        assert set(filters.keys()) == {"id", "headline", "pub_date", "reporter"}
    ...
    def test_get_filters_without_generic_foreign_key(self):
        ...
        assert set(filters.keys()) == {"id", "name", "a", "content_type", "object_id"}
    ...
    def test_get_form_field_for_field(self):
        ...
        assert isinstance(
            fs._get_form_field_for_field(models.CharField()), forms.CharField
        )
        assert isinstance(
            fs._get_form_field_for_field(models.AutoField()), forms.IntegerField
        )
        assert isinstance(
            fs._get_form_field_for_field(models.FileField()), forms.CharField
        )
