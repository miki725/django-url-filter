...
router.register('many-to-one/reporters', m2o_api.ReporterViewSet, 'many-to-many:reporter')
router.register('many-to-one/articles', m2o_api.ArticleViewSet, 'many-to-many:article')
